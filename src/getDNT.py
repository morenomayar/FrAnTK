...
Sample call: getDNT.py h1=popnameh1 h2=popnameh2 h3=popnameh3 h4=popnameh4 bsize=3500000 freqpref=prefix resdir=dirname category=somecategory
...
try:
	...
	Z=Dstat/jackSE
	Z
	O=open(resdir+"/D_"+"_".join([freqprefbase, h1, h2, h3, h4])+".txt", 'w')
